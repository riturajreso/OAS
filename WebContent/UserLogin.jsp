...
PreparedStatement pst1=conn.prepareStatement("select u_id,pass from userdetail where u_id=?");
...
{
	%>
	<center><h2>Welcome<%out.print(u_id1); %>!!!!!!</h2></center>
<br>
<br>
<br>
	<p><a href="check.jsp">Check Your Result</a><br></p>	
...
%>
<a href="UserLogin.html"> Login Again </a></h2>
<% 
}
pst1.executeUpdate();
pst1.close();
